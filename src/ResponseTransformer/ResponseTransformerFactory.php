...
use DhgateApi\ResponseTransformer\ResponseTransformerInterface;
...
class ResponseTransformerFactory
{
    ...
    public static function createResponseTransformer(ConfigInterface $config)
    {
        ...
        if ($reflectionClass->implementsInterface('\\DhgateApi\\ResponseTransformer\\ResponseTransformerInterface')) {
